          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-slate-900">تحليل الميزانية وتوليد التوصيات</h3>
                  <p className="text-[11px] text-slate-400 font-sans">دراسة مصاريفك ونمو ثروتك وصياغة استراتيجية مخصصة للهدف</p>
                </div>
              </div>
              <button
                onClick={handleGenerateAnalysis}
                disabled={isAnalyzing}
                className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs px-5 py-2.5 rounded-xl transition-all shadow-md shadow-indigo-600/10 flex items-center gap-1.5 disabled:opacity-50"
              >
                {isAnalyzing ? (
                  <>
